...
const FAQ: [string, string][] = [
  ...
  ["Is mijn data veilig?", "Synchroniseren gebeurt uitsluitend met jóuw eigen OneDrive-account; bokkiep heeft geen eigen server die je gegevens bewaart. Je data staat dus net zo veilig als je OneDrive zelf: zichtbaar voor jou — maar in principe ook voor Microsoft en voor personen of apps die toegang hebben tot jouw OneDrive (bijvoorbeeld een gedeeld account of een beheerder). Wil je dat helemaal afzekeren? Schakel dan bij Synchroniseren de end-to-end versleuteling in: je gegevens worden dan al vóór de upload op je eigen apparaat versleuteld met AES-256-GCM, met een sleutel die uit jouw wachtwoord wordt afgeleid via PBKDF2 (SHA-256, 600.000 iteraties). Dat is zero-knowledge — zonder jouw wachtwoord of herstelcode kan niemand de data lezen, ook Microsoft niet."],
